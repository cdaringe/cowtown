...
import { Route, Redirect, Switch, StaticRouter, StaticRouterContext } from 'react-router';
...
export const RedirectWithStatus: React.FC<{ from: string, to: string, statusCode: number}> =
  ({ from, to, statusCode }) =>
    <Route
    ...
    <Route path='/dashboard'>
      <div>
        ...
        <Switch>
          ...
          <Route path='/dashboard/overview' component={() => <h2>overview</h2>}  />
        </Switch>
      </div>
    </Route>
  </Switch>

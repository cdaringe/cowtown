...
-->
<svg width='75px' version="1.1" id="cowtown" xmlns="http://www.w3.org/2000/svg" x="0px"
  y="0px" viewBox="0 0 512.013 512.013" style={{enableBackground: 'new 0 0 512.013 512.013', stroke: 'white', fill: 'white'}}>
  <g>
    <g>
